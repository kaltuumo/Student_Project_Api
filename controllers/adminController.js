...
exports.signup = async (req, res) => {
    ...
    // Haddii password aanu jirin, ku dar default
    if (!password) {
        password = '123456';
    }
    ...
    try {
        ...
        // Format dates (sidaad hore u sameysay)
        ...
        // ✅ Abuuri token halkan kadib marka Admin la save gareeyo
        ...
        // hadda soo celi response-ka
        res.status(201).json({
            success: true,
            message: "Your Account Has been Created",
            token, // ✅ halkan ku dar token
            result: {
                _id: savedAdmin._id,
                fullname: savedAdmin.fullname,
                email: savedAdmin.email,
...
exports.login = async (req, res) => {
    ...
    try {
        ...
        if (!existingAdmin) {
            return res.status(401).json({ success: false, message: 'Admin does not exists!' });
        }

        // No bcrypt, compare plain text
